package com.playground.product.contract.application.outbound
 ...
 *
 * 내부 구현체(Entity)가 아닌 불변 객체인 [ProductInfo] VO를 반환하여
 * 도메인 간의 결합도를 낮춥니다.
 */
fun interface ProductInfoQueryPort {
     ...
     * @return 상품 ID를 Key로, [ProductInfo]를 Value로 하는 Map.
     *
