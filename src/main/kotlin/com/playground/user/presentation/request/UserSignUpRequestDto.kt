...
data class UserSignUpRequestDto(
    ...
    @field:Size(
        min = ValidationConstants.USER_LOGIN_ID_MIN_SIZE,
        max = ValidationConstants.USER_LOGIN_ID_MAX_SIZE,
        message = "{user.loginId.size}",
    )
    val loginId: String,
    @field:NotBlank(message = "{user.password.not-blank}")
    @field:Size(
        min = ValidationConstants.USER_PASSWORD_MIN_SIZE,
        max = ValidationConstants.USER_PASSWORD_MAX_SIZE,
    ...
    override fun toString(): String = "UserSignUpRequestDto(loginId='$loginId', password='****', nickname='$nickname')"
}
